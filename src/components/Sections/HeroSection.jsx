  ...
  return (
    <main className='flex'>
        <div className='w-3/5 p-8 py-44 lg:py-40 lg:mt-24'>
            ...
            <p className='py-2 text-gray-400 max-md:w-88'>I’m Tech Enthusiastic with a strong background in Computer Science and Programming. I’m a continuous learner and a self-taught full-stack developer.</p>
        ...
        {!isShown && <img src={JImage} alt="JImage" onMouseEnter={() => setIsShown(true)} onMouseLeave={() => setIsShown(false)} className='pt-1 lg:block hidden lg:mt-20' />}
        {isShown && <img src={JHover} alt="JImage" onMouseEnter={() => setIsShown(true)} onMouseLeave={() => setIsShown(false)} className='pt-1 lg:block hidden lg:mt-20' />}
    </main>
  )
}
