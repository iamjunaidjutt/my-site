...
const HeroSection = (props) => {
  ...
  return (
    <main className='flex'>
        ...
        {!isShown && <img src={JImage} alt="JImage" onMouseEnter={() => setIsShown(true)} onMouseLeave={() => setIsShown(false)} className='pt-1' />}
        {isShown && <img src={JHover} alt="JImage" onMouseEnter={() => setIsShown(true)} onMouseLeave={() => setIsShown(false)} className='pt-1' />}
    </main>
  )
}
